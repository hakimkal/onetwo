...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PartnerAndSponsor'
        db.create_table(u'partners_partnerandsponsor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(default='logo_images/None/no-img.jpg', max_length=100)),
            ...
            ('thumb_big', self.gf(u'django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'partners', ['PartnerAndSponsor'])


    def backwards(self, orm):
        # Deleting model 'PartnerAndSponsor'
        db.delete_table(u'partners_partnerandsponsor')
    ...
    models = {
        ...
        u'partners.partnerandsponsor': {
            'Meta': {'object_name': 'PartnerAndSponsor'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'default': "'logo_images/None/no-img.jpg'", 'max_length': '100'}),
